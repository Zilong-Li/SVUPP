...
In addition, there two main CSV files you need to prepare, i.e. =tests/samples.csv= and =tests/refpanel.csv=. Replace the values in these spreadsheets with your own data.
